...
class MainActivity : AppCompatActivity() {
    // 전역으로 선언만 했지, 할당을 안했음
    // 그래서, onCreate 라는 함수에서, 최초 1회 실행시 할당하는 구조
...
//        setContentView(R.layout.activity_main)
        ...
        // DatabaseHelper 클래스르 사용한다.
        // 객체 생성한다 ->
        myDB = DatabaseHelper(this)

        // 자바 버전에 코드 -> 코틀린 변경
        // findViewById -> 바인딩 기법으로 사용했었음
    ...
    fun viewAll() {
        buttonView!!.setOnClickListener(View.OnClickListener {
            // res에 조회된, 테이블의 내용이 들어가있다. select의 조회의 결과값이다.
            ...
            //res 형 => Cusor, 쉽게 엑셀 마치 테이블, 0행부터 시작한다.
